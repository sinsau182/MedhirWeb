  ...
  return (
    <>
      ...
      <div className={`${isLoading ? "pointer-events-none" : ""}`}>
        <aside
          className={`fixed top-16 left-0 h-[calc(100vh-64px)] transition-all duration-300 
          bg-gradient-to-b from-gray-50/80 to-blue-50/60 shadow-sm border-r border-slate-100
        ...
        >
          ...
          <div className="absolute -right-4 top-3 z-50">
            ...
            >
              {isCollapsed ? (
                <FaAngleRight className="w-5 h-5 text-slate-400" />
              ) : (
                <FaAngleLeft className="w-5 h-5 text-slate-400" />
              )}
            </button>
          </div>
                              ...
                              return (
                                ...
                                >
                                  <span className={`text-lg transition-transform duration-200 ${
                                    isSubActive ? "scale-110" : "hover:scale-110"
                                  }`}>
                                    {subItem.icon}
                                  </span>
                                  {!isCollapsed && (
