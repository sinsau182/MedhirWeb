...
const LeaveRequestTable = ({ requests, isLoading, onAction, isPending }) => {
  if (isLoading) {
    return <LeaveRequestTableSkeleton />;
  }
      ...
      <Table>
        <TableHeader className="bg-gray-50">
          <TableRow>
            ...
            <TableHead className="text-xs font-medium text-gray-500 uppercase">Type of Leave</TableHead>
            ...
            <TableHead className="text-xs font-medium text-gray-500 uppercase">Leave Balance</TableHead>
          ...
          {requests.length > 0 ? (
            requests.map((request) => (
              <TableRow key={request.id}>
                ...
                <TableCell>{request.leaveBalance} days</TableCell>
